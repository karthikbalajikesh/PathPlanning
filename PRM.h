...
public:
	...
	// constructor
	PRM(int zmax = 3, int xmax = 2, int cellWidth = 10, int cellHeight = 10, int radius = 10, int neighbours = 3, cood_vector coordinates = {});
	...
	double normDistance(double& A, double& B, double& C, pair<double, double>& Point);
};	
