...
PRM_Rad::PRM_Rad(int numIterations, int zmax, int xmax, int cellWidth, int cellHeight,
	double radius, cood_vector Obstacle_Coordinates):occupancy_grid(xmax,zmax,cellWidth,
...
void PRM_Rad::createLineEquation(double& A, double& B, double& C, GraphNode& node1, GraphNode& node2) {
...
bool PRM_Rad::checkDistanceMetric(double& A, double& B, double& C, Obstacle& square) {
...
double PRM_Rad::normDistance(double& A, double& B, double& C, double& z, double& x) {
...
double PRM_Rad::L2Distance(GraphNode& Node1, GraphNode& Node2) {
	double distance = 0;
